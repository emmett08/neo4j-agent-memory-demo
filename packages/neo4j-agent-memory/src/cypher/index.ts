...
export const cypher = {
  ...
  searchMemories: loadCypher("search_memories.cypher"),
  ...
  getKnowledgeGraphByTags: loadCypher("get_knowledge_graph_by_tags.cypher"),
  getKnowledgeGraphByTagsGraph: loadCypher("get_knowledge_graph_by_tags.graph.cypher"),
  getKnowledgeGraphByTagsApoc: loadCypher("get_knowledge_graph_by_tags.apoc.cypher"),
